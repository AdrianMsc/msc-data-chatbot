...
const LoginPage = () => {
  ...
  return (
    <main className="h-screen w-screen  flex items-center justify-center">
      <div className="max-w-md mx-auto p-6 shadow-md rounded bg-white items-center flex flex-col justify-center">
        <MscLogo width={150} />
        ...
        <form onSubmit={handleSubmit} className="space-y-4 w-full">
          <input
            type="email"
            placeholder="Correo"
            className="w-full p-2 border border-solid rounded"
            value={email}
